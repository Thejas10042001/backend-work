...
export const AnalysisView: React.FC<AnalysisViewProps> = ({ result, files, context }) => {
  ...
  return (
    <div className="space-y-12 pb-20">
      ...
      {/* Cognitive Performance Coaching Section */}
      <section className="bg-white rounded-[4rem] p-12 shadow-2xl border border-slate-200 overflow-hidden relative">
        <div className="flex items-center gap-4 mb-10">
          <div className="p-4 bg-emerald-600 text-white rounded-2xl shadow-lg"><ICONS.Sparkles /></div>
          <div>
            <h2 className="text-3xl font-black text-slate-900 tracking-tight">Cognitive Performance Coaching</h2>
            <p className="text-sm text-slate-500">Synthesized executive coaching grounded in buyer psychology.</p>
          </div>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
          <div className="p-8 rounded-[2.5rem] bg-emerald-50 border border-emerald-100 shadow-sm flex flex-col">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-10 h-10 bg-emerald-600 text-white rounded-xl flex items-center justify-center shadow-md"><ICONS.Growth /></div>
              <h4 className="text-[11px] font-black uppercase tracking-[0.2em] text-emerald-700">Strategic Dos</h4>
            </div>
            <ul className="space-y-4">
              {result.finalCoaching.dos.map((item, idx) => (
                <li key={idx} className="flex gap-4 items-start">
                  <div className="mt-1 w-5 h-5 shrink-0 rounded-full bg-emerald-200 flex items-center justify-center text-emerald-700">
          ...
          <div className="p-8 rounded-[2.5rem] bg-rose-50 border border-rose-100 shadow-sm flex flex-col">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-10 h-10 bg-rose-600 text-white rounded-xl flex items-center justify-center shadow-md"><ICONS.X /></div>
              <h4 className="text-[11px] font-black uppercase tracking-[0.2em] text-rose-700">Strategic Don'ts</h4>
            </div>
            <ul className="space-y-4">
              {result.finalCoaching.donts.map((item, idx) => (
                <li key={idx} className="flex gap-4 items-start">
                  <div className="mt-1 w-5 h-5 shrink-0 rounded-full bg-rose-200 flex items-center justify-center text-rose-700">
        ...
        <div className="p-10 rounded-[3rem] bg-slate-900 text-white shadow-2xl relative overflow-hidden group">
          <div className="absolute top-0 right-0 p-12 opacity-5"><ICONS.Brain className="w-64 h-64" /></div>
          <div className="relative z-10">
            <h4 className="text-[11px] font-black uppercase tracking-[0.4em] text-indigo-400 mb-4">Final Strategic Synthesis</h4>
            <p className="text-xl md:text-2xl font-black leading-tight italic tracking-tight">
              “{result.finalCoaching.finalAdvice}”
            </p>
          </div>
        </div>
      </section>
