        ...
        <div className="dark-glass rounded-[3rem] p-12 shadow-2xl text-center space-y-10 border border-white/5">
          ...
          <div className="space-y-6">
            ...
            <button 
              ...
              className="w-full flex items-center justify-center gap-4 bg-white hover:bg-slate-100 text-slate-900 px-8 py-5 rounded-[1.5rem] font-black text-xs uppercase tracking-widest transition-all shadow-xl hover:scale-[1.02] active:scale-[0.98] group"
            >
